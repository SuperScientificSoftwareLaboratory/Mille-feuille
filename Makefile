...
cg-mix:
	nvcc src/main-cg-mixed.cu $(NVCCFLAGS) $(LDFLAGS) $(INCLUDES) -o main-cg-mixed -Xcompiler -fopenmp -O3 -maxrregcount=32
bicg-mix:
	nvcc src/main-bicg-mixed.cu $(NVCCFLAGS) $(LDFLAGS) $(INCLUDES) -o main-bicg-mixed -Xcompiler -fopenmp -O3 -maxrregcount=32
clean:
	rm main-cg
	rm main-bicg
	rm data/*.csv
